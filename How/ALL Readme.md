...
```
---------------------------------------------------------------------
2.2. Имидж движется вверх и когда достигает верха, то останавливается
...
```
---------------------------------------------------------------------
2.3. Имидж движется вверх и когда достигает верха, то идет вниз
...
```
---------------------------------------------------------------------
2.4. Имидж движется вверх и когда достигает верха, то идет вниз,
